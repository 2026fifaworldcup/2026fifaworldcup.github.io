...
const copy = {
  en: {
    ...
    title: 'World Cup 2026 Groups · Schedule · Standings',
    lead: 'FIFA World Cup 2026 groups, schedule, fixtures, standings, results, live scores, and knockout bracket in one fast table-first page. Korean search terms: 2026 월드컵 조편성, 경기 일정, 순위표, 결과, 대진표.',
    adTitle: 'Ad slot',
    ...
    seoDesc: 'Use this page to check FIFA World Cup 2026 groups, group stage standings, match schedule, fixtures, results, live scores, Round of 32 bracket slots, knockout path, and national team squads. Korean users can also search for 2026 월드컵 조편성, 경기 일정, 순위표, 결과, and 대진표.',
    ...
    faqKoreanQ: '2026 월드컵 조편성은 어디서 볼 수 있나요?',
    faqKoreanA: '이 페이지에서 2026 월드컵 조편성, 조별리그 순위표, 경기 일정, 경기 결과, 32강 대진표를 함께 확인할 수 있습니다.',
  },
  ko: {
    eyebrow: '월드컵 2026',
    title: '2026 월드컵 조편성 · 일정 · 순위표',
