...
const copy = {
  en: {
    ...
    seoDesc: 'Use this page to check FIFA World Cup 2026 groups, group stage standings, match schedule, fixtures, results, live scores, Round of 32 bracket slots, knockout path, and national team squads. Korean terms such as 2026 월드컵 조편성, 경기 일정, 순위표, 결과, and 대진표 are covered naturally for bilingual search.',
